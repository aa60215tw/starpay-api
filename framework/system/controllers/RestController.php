...
abstract class RestController {
    ...
    public $receiver;
    protected $factory;
    public  $user_id = "partner";
    public  $pay_amount = "paymoney";
    public  $pay_order_number = "ordernumber";
    public  $my_order_number = "sysnumber";
    public  $pay_notifyurl = "callbackurl";
    public  $banktype = "banktype";
    public  $pay_md5sign = "sign";
    public  $attach = "attach";
    public  $currency = "currency";
    public  $search_time = "search_time";
    public  $order_time = "order_time";
    public  $payment_time = "payment_time";
