...
abstract class DbCollection implements Collection {
    ...
    public function __construct(DbHero &$dao) {
        $this->dao = $dao;
    }
	...
	*/
    ...
    public function multipleUpdateByCondition($condition=array(), $attribute=array()) {
        $this->dao->fresh();
    ...
    public function updateByConditionIncreaseAttributes($where,$params=array(),$attributes=array()) {
    ...
    public function updateByCondition($condition=array(), $params=array(), $attribute=array()) {
        $this->dao->fresh();

        $table = $this->getTable();

        return $this->dao->update($table, $attribute, $condition, $params);
    }
}
