...
require_once( FRAMEWORK_PATH . 'models/ManageArticales.php' );

class ManageArticalesCollection extends PermissionDbCollection
{
    ...
    {
		return "manage_articales";//表單名
	}

	public function getModelName()
    {
		return "ManageArticales";
	}
